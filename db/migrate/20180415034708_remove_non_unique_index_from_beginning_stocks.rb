class RemoveNonUniqueIndexFromBeginningStocks < ActiveRecord::Migration[5.0]
  def change
    remove_index :beginning_stocks, name: :index_beginning_stocks_on_warehouse_id
    remove_index :beginning_stock_months, name: :index_beginning_stock_months_on_beginning_stock_id
