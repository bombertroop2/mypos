Rails.application.configure do
  ...
  config.action_cable.url = 'ws://159.65.1.178/cable'
  config.web_socket_server_url = "ws://159.65.1.178/cable"
  config.action_cable.allowed_request_origins = [ 'http://159.65.1.178', 'https://159.65.1.178' ]
