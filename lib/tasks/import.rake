namespace :import do
  ...
  desc "Import Products bag.2 from Excel"
  task products_part_2: :environment do 
    workbook = Creek::Book.new Rails.root.join("public", "import product table format bag. 2.xlsx").to_s
    worksheets = workbook.sheets
  ...
  desc "Import Products bag.3 from Excel"
  task products_part_3: :environment do 
    workbook = Creek::Book.new Rails.root.join("public", "daftar product yang di skip.xlsx").to_s
    worksheets = workbook.sheets
