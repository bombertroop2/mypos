$(function () {
    ...
    $('#filter-ap-invoice-courier-due-date').daterangepicker(
            {
                locale: {
                    format: 'DD/MM/YYYY'
                },
    ...
    $('#filter-ap-invoice-courier-due-date').on('apply.daterangepicker', function (ev, picker) {
        $(this).val(picker.startDate.format('DD/MM/YYYY') + ' - ' + picker.endDate.format('DD/MM/YYYY'));
    });

    $('#filter-ap-invoice-courier-due-date').on('cancel.daterangepicker', function (ev, picker) {
        $(this).val('');
    });
    ...
    $("#search-ap-invoice-courier-btn").click(function () {
        ...
        $("#filter_ap_invoice_courier_due_date").val($("#filter-ap-invoice-courier-due-date").val());
