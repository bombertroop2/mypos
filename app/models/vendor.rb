class Vendor < ApplicationRecord
  ...
  validates :taxpayer_identification_number, :taxpayer_identification_number_address, presence: true, if: proc{|v| v.vendor_type.eql?("Local")}
    validates :taxpayer_identification_number, presence: true, if: proc{|v| !v.vendor_type.eql?("Local") && v.taxpayer_identification_number_address.present?}
      validates :taxpayer_identification_number_address, presence: true, if: proc{|v| !v.vendor_type.eql?("Local") && v.taxpayer_identification_number.present?}
