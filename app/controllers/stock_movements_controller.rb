      ...
      unless params[:product_code].present?
        ...
        @stock_movement_transactions = if @warehouse.warehouse_type.eql?("central")
          ...
          StockMovementTransaction.
            ...
            group(:stock_movement_product_detail_id, :"products.code", :"brands_products.name", :"common_fields.code", :"common_fields.name", :size, :size_order, :"stock_movement_product_details.beginning_stock", :ending_stock, :"stock_movement_product_details.size_id").
