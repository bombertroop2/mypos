...
class PackingListsController < ApplicationController
  ...
  def packing_list_params
    params.require(:packing_list).permit(:courier_unit_id, :departure_date, :attr_courier_id, :attr_courier_price_type, :attr_courier_way_id, :attr_city_id,
      packing_list_items_attributes: [:shipment_id, :volume, :weight, :_destroy, :attr_delivery_date, :attr_do_number, :attr_quantity, :attr_courier_id, :attr_city_id, :attr_packing_list_date, :attr_courier_unit_id, :attr_received_date])
  end
end
