...
class ListingStocksController < ApplicationController
  ...
  def index
    ...
    @listing_stock_transactions = smart_listing_create(:listing_stock_transactions, listing_stock_transactions_scope, partial: 'listing_stocks/listing', paginate: false, default_sort: {transaction_date: "ASC", product_code: "ASC"})
  end
